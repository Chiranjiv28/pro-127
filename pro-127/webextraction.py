...
def scrape():
        ...
        # Find <table>
        bright_star_table = soup.find("table", attrs={"class", "wikitable floatright"})
...
for i in range(0,len(scarped_data)):
    ...
    Star_names = scarped_data[i][2]
    Distance = scarped_data[i][4]
    Mass = scarped_data[i][3]
    Radius = scarped_data[i][5]
    Lum = scarped_data[i][1]
